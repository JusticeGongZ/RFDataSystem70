...
//                        doubleBufferPhasePass1.put(num_pass1Phase);
    ...
    static DoubleBuffer doubleBufferPhasePass1 = DoubleBuffer.allocate(5000);
    ...
    public static void isOverLimitPhasePass1(String key, byte[] data, double PhaseUplimitNum) throws InterruptedException, IOException {
        ...
        for (int i = 0; i < data.length; i += 2) {
            ...
            if (doubleBufferPhasePass1.position() < doubleBufferPhasePass1.capacity() && num_pass1Phase != 0) {
                if (PhaseUplimitNum != Double.POSITIVE_INFINITY && Math.abs(num_pass1Phase - PhaseUplimitNum) > 2) {
...
//            packageDataConserve.set(key, doubleBufferPhasePass1, PhaseUplimitNum);
            PackageDataConserve.pass1PhaseSave("pass1_PHASE",doubleBufferPhasePass1,PhaseUplimitNum);
            sign =false;
        }
    }
    ...
    static double[] convertDataDouble_pass1Amp = new double[5000];

    public static double[] ByteArray2DoubleArray_pass1Amp(byte[] data) throws IOException {
...
//                }
    ...
    public static double[] ByteArray2DoubleArray(byte[] data) throws IOException {

        for (int i = 0; i < data.length; i += 2) {
            System.arraycopy(data, i, tempDouble, 0, 2);
            numDouble = byteToShort(tempDouble);
            if (numDouble != 0) {
                convertDataDouble[i / 2] = numDouble;
//                if (convertDataDouble[i / 2] >2){
//
...
//                }
    ...
    public static double[] ByteArray2DoubleArray_pass2Amp(byte[] data) throws IOException {
...
//                }
    ...
    public static double[] ByteArray2DoubleArray_pass3Amp(byte[] data) throws IOException {
...
//                }
    ...
    static byte[] tempDouble_pass4Amp = new byte[2];
    static short numDouble_pass4Amp = 0;
    static double[] convertDataDouble_pass4Amp = new double[512];

    public static double[] ByteArray2DoubleArray_pass4Amp(byte[] data) throws IOException {
...
//                }
    ...
    static byte[] tempDouble_pass1Phase = new byte[2];
    static short numDouble_pass1Phase = 0;
    static double[] convertDataDouble_pass1Phase = new double[5000];
    static double conversionFactor = 1.0 / 8192 * 180 / Math.PI;


    public synchronized static double[] ByteArray2DoubleArray_pass1Phase(byte[] data) throws IOException {
        for (int i = 0; i < data.length; i += 2) {
...
//                }
    ...
    static byte[] tempDouble_pass2Phase = new byte[2];
    static short numDouble_pass2Phase = 0;
    static double[] convertDataDouble_pass2Phase = new double[512];

    public static double[] ByteArray2DoubleArray_pass2Phase(byte[] data) throws IOException {
...
//                }
    ...
    static byte[] tempDouble_pass3Phase = new byte[2];
    static short numDouble_pass3Phase = 0;
    static double[] convertDataDouble_pass3Phase = new double[512];

    public static double[] ByteArray2DoubleArray_pass3Phase(byte[] data) throws IOException {
...
//                }
    ...
    static byte[] tempDouble_pass4Phase = new byte[2];
    static short numDouble_pass4Phase = 0;
    static double[] convertDataDouble_pass4Phase = new double[512];

    public static double[] ByteArray2DoubleArray_pass4Phase(byte[] data) throws IOException {
