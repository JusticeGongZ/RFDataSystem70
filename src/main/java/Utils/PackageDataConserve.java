...
public class PackageDataConserve implements  Runnable{
    ...
    public static void pass1PhaseSave(String key, DoubleBuffer doubleBuffer, double limitNum) throws IOException {
        System.out.println("开始保存数据");
        try {
